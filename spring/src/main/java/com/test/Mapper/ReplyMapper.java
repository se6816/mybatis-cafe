...
public interface ReplyMapper {
	...
	public List<ReplyVO> listCriteria(@Param("bid") int bid,@Param("replyPageCriteria")replyPageCriteria replyPageCriteria,@Param("boardType") BoardType boardType) throws Exception;
